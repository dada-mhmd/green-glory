...
const ServiceExplorer: React.FC = () => {
  ...
  const services: Service[] = [
    {
      ...
      title: 'Sustainable Paper Solutions',
      description:
        'Revolutionary eco-friendly paper products made from recycled materials with zero environmental impact.',
    ...
    },
    {
      ...
      title: 'Advanced Printing Technology',
      description:
        'State-of-the-art printing services with quantum-enhanced precision and eco-friendly inks.',
    ...
    },
    {
      ...
      title: 'Security Services',
      description:
        'Next-generation security solutions with AI-powered threat detection and blockchain verification.',
    ...
    },
    {
      ...
      title: 'Government Tenders',
      description:
        'Specialized tender management with automated compliance checking and digital submissions.',
  ...
  const handleDragEnd = () => setDraggedService(null);
  ...
  const handleARView = async (serviceId: string) => {
    console.log(`Opening AR view for ${serviceId}`);
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        >
          <h2 className="text-4xl md:text-6xl font-['Orbitron'] font-bold mb-6">
            <span className='gradient-text'>Interactive Service</span>
            <br />
            <span className='text-white'>Explorer</span>
          </h2>
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Drag and drop to explore our revolutionary services. Experience the
            future of sustainable business solutions.
          </p>
        </motion.div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
          {services.map((service, index) => (
            ...
            >
              <Card className='glass-card h-full hover-glow transition-all duration-300'>
                  ...
                  <div className='flex flex-col lg:flex-row items-center gap-8'>
                    <div className='flex-1'>
                      <div className='flex items-center space-x-4 mb-6'>
                        <div
                          className={`w-20 h-20 rounded-xl bg-gradient-to-r ${service.color} flex items-center justify-center text-white`}
                        >
                          {service.icon}
                        </div>
                        <div>
                      ...
                      <div className='grid grid-cols-2 gap-4 mb-8'>
                        {service.features.map((feature, idx) => (
                          <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: idx * 0.1 }}
                            className='flex items-center space-x-3 glass-panel p-3 rounded-lg'
                          >
                      ...
                      <div className='flex space-x-4'>
                        <Button className='glass-button hover-glow'>
                          Get Quote
        ...
        {isCameraOpen && (
          <div className='flex flex-col items-center mt-10 space-y-4'>
            <video
              ref={videoRef}
              className='w-full max-w-md rounded-xl border border-cyan-500'
              autoPlay
              muted
            />
            <Button
              variant='outline'
              className='glass-button border-red-400 text-red-400'
